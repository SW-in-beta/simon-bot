...
**Phase 4 피처 위임 시:**
```bash
bash ~/.claude/skills/simon-monitor/scripts/emit.sh child_session "4/exec" "Feature N: 기능명 → simon 위임" '{"child_session_id":"feat/xxx","delegated_skill":"simon","feature":"기능명","force_path":"SMALL"}'
```
